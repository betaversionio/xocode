...
const folderStructure = `my-generator/
  generator.yaml       ← required manifest
...
const minimalGenerator = `name: acme/hello-world
type: feature
actions:
  - type: template
...
const fullGenerator = `name: acme/react-component
type: feature
requires:
  - acme/react-setup
conflicts:
    ...
    <article className="max-w-3xl space-y-10">
      <div>
        ...
        <p className="text-base leading-relaxed text-muted-foreground">
          A generator is a folder with a <code>generator.yaml</code> manifest and any template files
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          There is no required file organization beyond <code>generator.yaml</code> at the root.
        </p>
      ...
      <section className="space-y-4">
        ...
        <CodeBlock code={minimalGenerator} filename="generator.yaml" lang="yaml" />
      ...
      <section className="space-y-4">
        <h2 className="text-xl font-semibold">generator.yaml reference</h2>
  ...
  - signal: framework
    matches: "^(react|nextjs)$"`}
      ...
      <section className="space-y-4">
        ...
        <CodeBlock code={fullGenerator} filename="generator.yaml" lang="yaml" />
